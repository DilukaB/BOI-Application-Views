...
const InvestmentDocumentChecklist = () => {
  return (
    <div className="max-w-6xl mx-auto p-8 bg-white rounded-2xl shadow-lg border border-gray-200">
      <h2 className="text-3xl font-bold text-gray-900 mb-8 border-b border-gray-300 pb-3">
        Annexure I
      </h2>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
        {/* Investment Section */}
        <section>
          <h3 className="text-xl font-semibold text-blue-800 mb-6 border-l-4 border-blue-600 pl-4">
            Investment
          </h3>
          <ol className="list-decimal list-inside space-y-6 text-gray-700 text-[15px] pl-2">
            <li>
              <span className="font-medium">Brief project description</span>
              <br />
              <span className="text-gray-600 block mt-1">
                (In case project investment is less than US $500,000)
                <br />
            ...
            <li>
              ...
              <br />
              <span className="text-gray-600 text-sm">(If an existing company is submitting the application)</span>
            </li>
            <li>
            ...
            <li>
              Process Floor Chart (if any)
              <br />
              <span className="text-gray-600 text-sm">(In case of a manufacturing company)</span>
            </li>
            <li>
        ...
        <section>
          ...
          <ol start={7} className="list-decimal list-inside space-y-6 text-gray-700 text-[15px] pl-2">
